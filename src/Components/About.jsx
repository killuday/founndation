  ...
  return (
    ...
    <div className='bg-hero relative bg-center bg-cover bg-no-repeat bg-fixed   '>
       ...
       <div className="flex flex-row">
        ...
        <div className="basis-1/2 z-10">
            <h1 className='font-oswald font-extrabold text-[4rem] uppercase pt-16 pl-32'>our mission</h1>
            <p className='pl-16 font-raleway text-base pt-8'>Accusantium dignissimos voluptas rem consequatur blanditiis error ratione illo sit quasi ut, praesentium magnam, pariatur quae, necessitatibus</p>
            <p className='pl-16 font-raleway text-base pt-8'>Dolor, eligendi voluptate ducimus itaque esse autem perspiciatis sint! Recusandae dolor aliquid inventore sit</p>
        </div>
