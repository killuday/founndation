  ...
  return (
    <>
      <div className="container mx-auto  p-20">
        <h1 className=" text-[4rem] text-center mt-5  font-bold title-font font-oswald mb-4 text-black uppercase">
          Our Blog
        </h1>
        ...
        <div className="flex pt-6">
          <div className="basis-1/2 pr-3 ">
            <img
              ...
              alt=""
            />
            <h3 className="capitalize font-oswald font text-orange-500 text-3xl pt-6 hover:text-orange-800 transition-colors">
            ...
            <p className="pt-3 text-xs font-raleway tracking-wider">
              ...
              <span className=" uppercase text-orange-500">jamers cooper</span>
            </p>
            ...
            <p className="pt-5">
              <span className="capitalize  text-orange-500 hover:text-orange-800 text-base font-medium transition-colors font-raleway ">
                get started
              </span>
            </p>
          </div>
